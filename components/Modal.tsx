      ...
      <Dialog as="div" className="relative z-[100]" onClose={handleStateChange}>
        ...
        <div className="fixed inset-0 z-[100] overflow-y-auto">
          <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative px-4 pt-5 pb-4 md:overflow-hidden text-left transition-all transform border rounded-lg shadow-xl bg-bg border-white/10 sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
