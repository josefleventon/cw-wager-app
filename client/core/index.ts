...
import { WagerQueryClient } from 'types/Wager.client'
...
export class StargazeClient {
  ...
  private _wagerClient: WagerQueryClient | null = null
  ...
  public async connect() {
    ...
    this._wagerClient = new WagerQueryClient(
      this.cosmWasmClient,
      this.wagerContract,
    )
  }
  ...
  public get wagerClient(): WagerQueryClient {
    return this._wagerClient as WagerQueryClient
  }
